...
*/
TEST_CASE("KDTree::findNearestNeighbor (2D), testing correct path with fence jumping", "[weight=1][kdtree]") {
...
TEST_CASE("KDTree::findNearestNeighbor (3D), testing tie-breaking", "[weight=1][kdtree]") {
